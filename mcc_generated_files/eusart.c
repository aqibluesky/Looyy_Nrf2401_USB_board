...
void EUSART_Write_MSG(uint8_t *msg , uint8_t size) 
{
...
void EUSART_Receive_ISR(void) 
{
    ...
    if(EUSART_RX_COUNT < 10)
    {
        EUSART_RX_BUF[EUSART_RX_COUNT]=RC1REG;
        if(EUSART_RX_COUNT == 9)EUSART_RX_FLAG=1;
    }
    if(EUSART_RX_COUNT >= 10)
    {
        EUSART_RB_BUF_TEMP[0]=RC1REG;
        EUSART_RB_BUF_TEMP[0]=0;
    }
    EUSART_RX_COUNT++;
    if(EUSART_RX_COUNT > 11) EUSART_RX_COUNT =0;
}
/**
  End of File
 */
